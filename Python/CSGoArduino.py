...
class GsiRequestHandler(BaseHTTPRequestHandler):
	...
	def parse_gsi_json(self, gsi_json):
		...
		player_match_stats_packet = str(player_match_stats_kills) + ',' +str(player_match_stats_assists) + ',' +str(player_match_stats_deaths) + ',' +str(player_match_stats_mvps) + ',' +str(player_match_stats_score)
		send_player_match_stats_packet(player_match_stats_packet)
				
		map_packet = str(map_team_ct_score) + ',' + str(map_team_t_score) + ',' + str(map_mode) + ',' + str(map_name) + ',' + str(map_round)
